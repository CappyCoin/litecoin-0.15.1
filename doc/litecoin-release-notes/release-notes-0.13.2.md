...
Then, to tunnel a SSL connection on 29138 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 29138 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /litecoinrpc>
        ProxyPass http://127.0.0.1:9138/
        ProxyPassReverse http://127.0.0.1:9138/
